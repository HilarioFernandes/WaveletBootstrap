     ...
     while((l <= N)){
       ...
       bern <- sample(0:1, 1, prob = c(1-param,param))
        ...
        if(bern == 0){
          ...
          sampled_indexes <- c(sampled_indexes,
...
if (FALSE) {
  Y <- rnorm(1024)
  wv_boot_estimates <- bootstrap_wavelet(Y, "wb", TRUE, "MBB", function(N){floor(N/4)}, 10)
  wv_boot_estimates <- bootstrap_wavelet(Y, "wb", FALSE, "MBB", function(N){floor(N/4)}, 10)
  wv_boot_estimates <- bootstrap_wavelet(Y, "wb", TRUE, "SB", function(N){N^{-1}}, 10)
  wv_boot_estimates <- bootstrap_wavelet(Y, "wb", FALSE, "SB", function(N){N^{-1}}, 10)
  wv_boot_estimates <- bootstrap_wavelet(Y, "bw", TRUE, "MBB", function(N){floor(N/4)}, 10)
  wv_boot_estimates <- bootstrap_wavelet(Y, "bw", FALSE, "MBB", function(N){floor(N/4)}, 10)
  wv_boot_estimates <- bootstrap_wavelet(Y, "bw", TRUE, "SB", function(N){N^{-1}}, 10)
  wv_boot_estimates <- bootstrap_wavelet(Y, "bw", FALSE, "SB", function(N){N^{-1}}, 10)
}
